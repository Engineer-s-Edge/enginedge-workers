...
class BulletEvaluator:
    def __init__(self):
        ...
        self.buzzwords = [
            "dynamic", "results-driven", "ninja", "rockstar", "synergy",
            "leverage", "utilize", "passionate", "team player", "hard worker",
    ...
    def _check_business_outcome(self, bullet: str) -> Dict[str, Any]:
        ...
        business_keywords = [
            ...
            'user', 'conversion', 'retention', 'growth', 'scale',
    ...
    def _check_front_loaded(self, bullet: str) -> Dict[str, Any]:
        ...
        return {
            "pass": has_early_metric,
            "score": 1.0 if has_early_metric else 0.5
        }
    ...
    def _generate_fixes(
        ...
        if not kpis['quantifiable']['pass']:
            fixes.append({
                ...
                "confidence": 0.7,
                "latexPatch": bullet + " [ADD METRIC: X% improvement / Y users / Z ms]"
            })
    ...
    def _load_action_verbs(self) -> List[str]:
        ...
        return [
            ...
            "Spearheaded", "Championed", "Drove", "Guided", "Mentored", "Coached",
            ...
            "Optimized", "Improved", "Enhanced", "Streamlined", "Refactored", "Modernized",
            "Automated", "Accelerated", "Reduced", "Increased", "Boosted", "Elevated",
            
            # Analysis/Research
            "Analyzed", "Researched", "Investigated", "Evaluated", "Assessed", "Diagnosed",
            "Identified", "Discovered", "Uncovered", "Determined", "Measured", "Quantified",
            
            # Collaboration/Communication
            "Collaborated", "Partnered", "Coordinated", "Communicated", "Presented",
            "Documented", "Trained", "Educated", "Advised", "Consulted", "Facilitated",
            
            # Problem-Solving
            "Solved", "Resolved", "Debugged", "Troubleshot", "Fixed", "Remediated",
            "Mitigated", "Prevented", "Eliminated", "Addressed", "Corrected",
            
            # Data/Metrics
            "Tracked", "Monitored", "Measured", "Reported", "Visualized", "Dashboarded",
            
            # More verbs...
            "Achieved", "Delivered", "Executed", "Established", "Initiated", "Pioneered",
            "Transformed", "Revamped", "Scaled", "Expanded", "Integrated", "Migrated"
        ]
