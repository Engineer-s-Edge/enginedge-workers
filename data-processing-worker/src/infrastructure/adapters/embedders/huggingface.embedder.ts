...
export class HuggingFaceEmbedderAdapter implements EmbedderPort {
  ...
  constructor() {
    this.logger.warn('Hugging Face embedder is disabled. This is a placeholder implementation.');
  }

  async embedText(_text: string): Promise<number[]> {
    throw new Error('Hugging Face embedder is disabled. Please use OpenAI or Google embedders.');
  }
