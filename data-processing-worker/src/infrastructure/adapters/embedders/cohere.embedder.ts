...
export class CohereEmbedderAdapter implements EmbedderPort {
  ...
  constructor() {
    this.logger.warn('Cohere embedder is disabled. This is a placeholder implementation.');
  }

  async embedText(_text: string): Promise<number[]> {
    throw new Error('Cohere embedder is disabled. Please use OpenAI or Google embedders.');
  }
