...
describe('YouTubeRetriever', () => {
  ...
  describe('Basic Properties', () => {
    it('should have correct name and description', () => {
      ...
      expect(retriever.description).toContain(
  ...
  describe('Input Validation', () => {
    ...
    it('should accept valid query', async () => {
      ...
      expect(result.error!.message).toContain(
        'YouTube search failed: Service unavailable',
      );
    });
  });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle invalid request (400)', async () => {
      ...
      expect(result.success).toBe(false);
      expect(result.error!.message).toBe(
        'Invalid YouTube API request parameters',
      );
    });
    ...
    it('should handle generic API errors', async () => {
      ...
      expect(result.success).toBe(false);
      expect(result.error!.message).toBe(
        'YouTube search failed: Internal server error',
      );
    });
    ...
    it('should handle network errors without response', async () => {
      ...
      expect(result.success).toBe(false);
      expect(result.error!.message).toBe(
        'YouTube search failed: Network error',
      );
    });
    ...
    it('should handle malformed API responses', async () => {
      ...
      expect(result.success).toBe(false);
      expect(result.error!.message).toBe(
        'YouTube search failed: Unknown error',
      );
    });
          ...
          items: Array(50)
            ...
            .map((_, i) => ({
              ...
              snippet: {
                ...
                publishedAt: '2023-01-01T00:00:00Z',
                thumbnails: {
                  default: { url: `thumb${i}.jpg`, width: 120, height: 90 },
                },
              },
            })),
        },
