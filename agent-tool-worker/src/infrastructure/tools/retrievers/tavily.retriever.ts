...
export class TavilyRetriever extends BaseRetriever<TavilyArgs, TavilyOutput> {
  ...
  readonly description =
    'Search the web using Tavily API for comprehensive search results with snippets, titles, and URLs';
  ...
  readonly inputSchema = {
    ...
    properties: {
      ...
      search_depth: {
        ...
        enum: ['basic', 'advanced'],
        description:
          'Search depth - basic for faster results, advanced for comprehensive search',
        default: 'basic',
      },
      include_images: {
        type: 'boolean',
  ...
  readonly errorEvents: ErrorEvent[] = [
    new ErrorEvent(
      'tavily-service-unavailable',
      'Tavily service is not available',
      false,
    ),
    new ErrorEvent(
